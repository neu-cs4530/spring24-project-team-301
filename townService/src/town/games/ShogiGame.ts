...
import { ConnectFourGameState, ConnectFourMove, GameMove, ShogiGameState, ShogiMove } from "../../types/CoveyTownSocket";
...
export default class ShogiGame extends Game<ShogiGameState, ShogiMove> {
     ...
     */
    private boardToSfen(board : string[][]) : string {
    ...
    protected validateMove(move: GameMove<ShogiMove>): boolean {
        const { playerID, move: { from, to } } = move;
